...
def get_keywords():
    ...
    # get_keywords().
    git_refnames = " (HEAD -> master, tag: 0.8)"
    git_full = "e5323658b3d02bf03bad6165115a97b7637123f7"
    git_date = "2021-09-24 10:14:30 -0700"
...
def get_config():
    ...
    cfg.versionfile_source = "plip/_version.py"
    cfg.verbose = False
    return cfg
